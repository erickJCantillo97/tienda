        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-base font-semibold leading-6 text-gray-900">Ventas</h1>
                    <p class="mt-2 text-sm text-gray-700">Aqui esta el listado de todas las Ventas.</p>
                </div>
                    ...
                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tbody class="bg-white">
                                <tr v-for="product in sales" class="even:bg-gray-50">
                                    <td
...
const { formSale } = storeToRefs(store);
...
function submitForm(event: Event): void {
    ...
    formSale.value.transform((data: { name: string, price: number, products: Array<Product> }) => ({
        ...data
    })).post('sales', {
        onSuccess: () => {
            show.value = false;
            formSale.value.reset();
        }
    });
}
function addProduct(): void {
    formSale.value.products.push({
        quantity: '',
        product_id: 0,
    });
}
